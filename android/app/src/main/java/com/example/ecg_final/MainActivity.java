...
//    private EcgTest ecgTest;
    public void main(){
        ...
        ecg.sample();
        ecg.setUpConnection();
       // EcgPosition[] ecgPositions={}

//        EcgPosition[] ecgPositionsArray={EcgPosition.LEAD_2};
//        ecg.performLeadTest(EcgTestType.LEAD_TWO, ecgPositionsArray,0,ecgPositionsArray.length);
////        //ecg.performLeadTest();
...
//        SpandanSDK.initialize(getApplication(), "iDOSFfTw712TOGIu", new OnInitializationCompleteListener() {
//            @Override
