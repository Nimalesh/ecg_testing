...
class Ecg : FlutterActivity() {
    private val TAG = "Ecg.TAG"
    private val CHANNEL = "com.example.calidad_app/sericom"
    private val CHANNEL_EVENT = "com.example.calidad_app/sericom_event"
...
//                            if (::span.isInitialized) span.unbind(application)
        ...
        eventChannel.setStreamHandler(object : StreamHandler {
            override fun onListen(arguments: Any?, events: EventChannel.EventSink?) {
                ...
                shareResultClass.observe(this@Ecg) {
    ...
    {
        Log.d(
            "Test_Tag", "performLeadTest: EcgTestType --> $testType EcgPositionArray --> $ecgPositionArray"
        )
                                ...
                                override fun onReportGenerationSuccess(ecgReport: EcgReport) {
                                    if (testType == EcgTestType.LEAD_TWO) {
                                        ...
                                        runOnUiThread {
                                            ...
                                            Toast.makeText(this@Ecg, "$ecgPositionName : Lead two report successful...${resultData.value}", Toast.LENGTH_SHORT).show()
                                        }
                                    }
                                        ...
                                        runOnUiThread {
                                            resultData.value =
                                                "Detection --> ${conclusion.detection}\n" +
                                                        ...
                                                        "ECG Data --> ${ecgReport.ecgData}"
                                            Toast.makeText(this@Ecg, "$ecgPositionName : Twelve Lead report successful...${resultData.value}", Toast.LENGTH_SHORT).show()
                                        }
                                    }
                                }
    ...
    public fun setUpConnection() {
        ...
        val ecgPositionsArray = arrayOf(EcgPosition.LEAD_2)
        performLeadTest(EcgTestType.LEAD_TWO, ecgPositionsArray, 0, ecgPositionsArray.size)
        //performLeadTest()

    }
    fun sample(){
        Log.d("Test_Tag", "Hellooooooooooooooooooooooooooooooooo")
...
////        // You can use "this" keyword to refer to the current instance of the Application class
////
////        // Sample code:
